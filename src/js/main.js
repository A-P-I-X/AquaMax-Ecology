...
var sb = $('sidebar');if(sb && window.innerWidth<=900){sb.classList.remove('open');}
});
});
var tg = $('sidebar-toggle');
if(tg){tg.addEventListener('click',function(){$('sidebar').classList.toggle('open');});}
}
